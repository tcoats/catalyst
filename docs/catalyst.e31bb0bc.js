...
inject('page:default', ql.component({
  ...
  render: function render(state, params, hub) {
    ...
    var content = marked(file.content);
    return h('div.wrapper', [h('header', [h('h1', 'Mind Catalyst')]), h('div.caption', file.data.title), h('article', {
      props: {
        innerHTML: content
      },
      style: {
        'border-left-color': file.data.color
      }
    }), h('nav', [])]);
  }
}));
},{"snabbdom/h":"node_modules/snabbdom/h.js","odoql2":"node_modules/odoql2/index.js","injectinto":"node_modules/injectinto/inject.js","odo-route":"node_modules/odo-route/index.js","page":"node_modules/page/page.js","gray-matter":"node_modules/gray-matter/index.js","marked":"node_modules/marked/lib/marked.js"}],"error.js":[function(require,module,exports) {
var h = require('snabbdom/h').default;
